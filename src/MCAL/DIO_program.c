...
// Global Functions
//==============================================================================
E_Status DIO_u8SetPinDirection(uint8_t copy_u8Port, uint8_t copy_u8Pin, uint8_t copy_u8Direction)
{
...
E_Status DIO_u8SetPortDirection(uint8_t copy_u8Port, uint8_t copy_u8Direction)
{
    E_Status Local_u8ErrorState = E_OK;
